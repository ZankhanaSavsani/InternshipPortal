...
const AdminNotificationsPage = () => {
  ...
  const markAsRead = async (notificationId) => {
    try {
      await axios.put(`${process.env.REACT_APP_BACKEND_BASEURL}/api/notifications/${notificationId}/mark-read`, {}, {
        withCredentials: true
      });
  ...
  const markAllAsRead = async () => {
    try {
      await axios.put(`${process.env.REACT_APP_BACKEND_BASEURL}/api/notifications/mark-all-read`, {}, {
        withCredentials: true
      });
